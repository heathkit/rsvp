module Hkit.RSVP.Application {
  ...
  var services: {
    ...
    $ionicHistory: any,
    RiderStatusService: Tracking.RiderStatusService
  };
  ...
  export function main(): void {
    ...
    ngModule.service(Tracking.RiderStatusService.ID, Tracking.RiderStatusService);
    ngModule.service(Settings.SettingsService.ID, Settings.SettingsService);
  ...
  function angular_initialize(
    ...
    services = {
      ...
      RiderStatusService: RiderStatusService
    };
  ...
  //var rideStatusUpdater = new RideStatusUpdater(); 
  ...
  function device_resume(): void {
    console.log("Device resume, starting updaters.");
    services.RiderStatusService.startUpdating();
  }
